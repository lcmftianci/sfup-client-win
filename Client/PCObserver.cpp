...
void PCObserver::RegisterRenderer(Renderer *renderer)
{
	...
	if (videoRenderer_)
	{
		videoRenderer_->RegisterRenderer(renderer_);
	}
}

void PCObserver::RegisterBTRenderer(Renderer *renderer)
{
	btRender = renderer;
	if (m_btVideoRenderer)
	{
		m_btVideoRenderer->RegisterRenderer(btRender);
	}
}
