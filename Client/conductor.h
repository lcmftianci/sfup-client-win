...
class Conductor	: public ConnectionClientObserver,	public PCbserverCallBack, public MainWndCallback {
public:

	//************************************
	// Method:    Conductor
	// FullName:  Conductor::Conductor
	// Access:    public 
	// Returns:   
	// Qualifier: 这个类将，网络消息与窗口消息整合在一起
	// Parameter: ConnectionClient * client
	// Parameter: MainWindow * main_wnd
	//************************************
	Conductor(ConnectionClient* client, MainWindow* main_wnd);
	Conductor(telemetry_client* client, MainWindow* main_wnd);
